                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="<?= avatar($user); ?>" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
                        ...
                        <form id="formAccountSettings" method="POST" onsubmit="return false">
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" type="text" id="nama" name="nama" value="<?= old("nama", $user['nama']); ?>" autofocus />
                                </div>
                                <div class="mb-3 col-md-6">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" id="no_telp" name="no_telp" class="form-control" placeholder="812-1000-7000" value="<?= old("no_telp", $user['no_telp']); ?>" />
                                    </div>
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="alamat" class="form-label">Alamat</label>
                                    <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat" value="<?= old("alamat", $user['alamat']); ?>" />
                                </div>
                                <div class="mb-3 col-md-6">
