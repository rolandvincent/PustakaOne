        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <!-- Account -->
                    <form id="formAccountSettings" method="POST" enctype="multipart/form-data" action="/admin/add?continue=<?= urlencode($redirect); ?>&sender=0&action=user">
                        <div class="card-body">
                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                <img src="/img/avatars/default.png" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control  <?= $validation->hasError("nama") ? "is-invalid" : ""; ?>" type="text" id="nama" name="nama" value="<?= old("nama"); ?>" placeholder="John Doe" autofocus />
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control <?= $validation->hasError("username") ? "is-invalid" : ""; ?>" type="text" name="username" id="username" value="<?= old("username"); ?>" placeholder="jon.doe" />
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control <?= $validation->hasError("email") ? "is-invalid" : ""; ?>" type="email" id="email" name="email" value="<?= old("email"); ?>" placeholder="john.doe@example.com" />
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="date" class="form-control <?= $validation->hasError("TTGL") ? "is-invalid" : ""; ?>" id="TTGL" name="TTGL" value="<?= old("TTGL"); ?>" />
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" id="no_telp" name="no_telp" class="form-control" placeholder="812-1000-7000" value="<?= old("no_telp"); ?>" />
                                    </div>
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="alamat" class="form-label">Alamat</label>
                                    <input type="text" class="form-control <?= $validation->hasError("alamat") ? "is-invalid" : ""; ?>" id="alamat" name="alamat" placeholder="Alamat" value="<?= old("alamat"); ?>" />
                                    <div class="invalid-feedback">
