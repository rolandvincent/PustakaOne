...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="/admin/kelola-member" class="menu-link">
                <i class="menu-icon fa-solid fa-pen-to-square"></i>
                <div data-i18n="Analytics">Kelola Member</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="/admin/kelola-pustakawan" class="menu-link">
                <i class="menu-icon fa-solid fa-pen-to-square"></i>
                <div data-i18n="Analytics">Kelola Pustakawan</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="/admin/kelola-buku" class="menu-link">
                <i class="menu-icon fa-solid fa-pen-to-square"></i>
        ...
        <li class="menu-item">
            <a href="/profil/edit" class="menu-link">
                <i class="menu-icon fa-solid fa-user-pen"></i>
                <div data-i18n="Analytics">Ganti Profil</div>
            </a>
        </li>
        <li class="menu-item">
