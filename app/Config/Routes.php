...
$routes->get('/admin/delete/buku/(:num)', 'Admin::hapus_buku/$1', ['filter' => 'auth']);
...
$routes->get('/admin/kelola-buku', 'Admin::kelolaBuku', ['filter' => 'auth']);
$routes->get('/admin/detail_user/([\w\d\-]+)', 'Admin::user_detail/$1', ['filter' => 'auth']);
$routes->get('/admin/edit_user', 'Admin::user_edit', ['filter' => 'auth']);
$routes->get('/admin/edit/buku/(:num)', 'Admin::edit_buku/$1', ['filter' => 'auth']);
$routes->post('/admin/edit/buku', 'Admin::edit_buku_apply', ['filter' => 'auth']);
$routes->get('/admin/add_user', 'Admin::user_add', ['filter' => 'auth']);
$routes->get('/admin/add/buku', 'Admin::buku_add', ['filter' => 'auth']);
$routes->post('/admin/add/buku', 'Admin::buku_add_apply', ['filter' => 'auth']);
$routes->get('/admin/detail/buku/(:num)', 'Admin::detail_buku/$1', ['filter' => 'auth']);
